      ...
      <main className="flex min-h-screen flex-col items-center justify-center">
        <Container>
          <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16">
            <ThemeToggle />
            <h1 className="motion-preset-slide-right-lg text-5xl font-extrabold tracking-tight sm:text-[5rem]">
...
const Logos = {
  tailwindcss: () => (
    <svg
      className={"h-[28px] w-[140px] sm:w-auto"}
  ...
  framer: () => (
    <div
      className={
        "flex h-fit items-center justify-start gap-3 text-xl font-bold"
      }
    >
      <svg
        viewBox="0 0 14 21"
  ...
  return (
    <Marquee>
      {arr.map((Logo) => (
        <div
          key={Logo.name}
          className="relative mx-[2.5rem] flex h-full w-fit items-center justify-start"
        >
          <Logo />
        </div>
      ))}
